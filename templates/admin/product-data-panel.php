...
<div id="addons_product_data" class="panel woocommerce_options_panel addons-admin">
    <div class="options_group">
        ...
        <div class="addons-empty" data-addons-empty<?php echo $addons_rows === array() ? '' : ' hidden'; ?>>
            ...
            <p><strong><?php esc_html_e('No add-ons yet', 'aldono'); ?></strong></p>
            <p><?php esc_html_e('Add your first option to let customers personalise this product or pay for extras such as gift wrapping, engraving, or express handling.', 'aldono'); ?></p>
        </div>
        ...
        <div class="addons-admin-rows" data-addons-rows>
            <?php foreach ($addons_rows as $addons_i => $addons_row) : ?>
                ...
                <div class="addons-admin-row" data-addons-row>
                    <p class="form-field">
                        <span class="addons-row-badge" aria-hidden="true"><?php esc_html_e('Option', 'aldono'); ?></span>
                        <input type="text" name="addons_def[<?php echo esc_attr((string) $addons_i); ?>][label]" placeholder="<?php esc_attr_e('Label (e.g. Gift wrap)', 'aldono'); ?>" value="<?php echo esc_attr($addons_label); ?>" aria-label="<?php esc_attr_e('Option label', 'aldono'); ?>" />
                        <select name="addons_def[<?php echo esc_attr((string) $addons_i); ?>][type]" aria-label="<?php esc_attr_e('Option type', 'aldono'); ?>">
                        ...
                        <label>
                            ...
                            <?php esc_html_e('Required', 'aldono'); ?>
                        </label>
        ...
        <p class="form-field">
            <button type="button" class="button button-primary addons-admin-add" data-addons-add><?php esc_html_e('Add option', 'aldono'); ?></button>
        </p>
        ...
        <script type="text/template" id="addons-row-template">
            <div class="addons-admin-row" data-addons-row>
                <p class="form-field">
                    <span class="addons-row-badge" aria-hidden="true"><?php esc_html_e('Option', 'aldono'); ?></span>
                    <input type="text" name="addons_def[__INDEX__][label]" placeholder="<?php esc_attr_e('Label (e.g. Gift wrap)', 'aldono'); ?>" value="" aria-label="<?php esc_attr_e('Option label', 'aldono'); ?>" />
                    <select name="addons_def[__INDEX__][type]" aria-label="<?php esc_attr_e('Option type', 'aldono'); ?>">
                    ...
                    <span class="addons-char-settings" data-addons-char-settings>
                        <input type="number" min="0" name="addons_def[__INDEX__][min_chars]" placeholder="<?php esc_attr_e('Min chars', 'aldono'); ?>" value="" style="width:6em;" aria-label="<?php esc_attr_e('Minimum character length', 'aldono'); ?>" />
                        <input type="number" min="0" name="addons_def[__INDEX__][max_chars]" placeholder="<?php esc_attr_e('Max chars', 'aldono'); ?>" value="" style="width:6em;" aria-label="<?php esc_attr_e('Maximum character length', 'aldono'); ?>" />
                    </span>
                    <label>
